...
const Group = async(() => import("../pages/security/group"));
const GroupPermission = async(() => import("../pages/security/groupPermission"));
const Permission = async(() => import("../pages/security/permission"));
const User = async(() => import("../pages/security/user"));
const UserGroup = async(() => import("../pages/security/userGroup"));
